     ...
     private void keepAwake()
     {
         try {
             ...
             if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S && e instanceof ForegroundServiceStartNotAllowedException) {
                 ...
                 Notification notification = new NotificationCompat.Builder(this, "foreground_notification_channel")
                         .setContentTitle("Digimentor24 has been restarted")
                         .setContentText("Go back to the app to resume lecture playback and downloads.")
